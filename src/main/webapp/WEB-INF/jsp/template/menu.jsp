    ...
    <div class="sidebar-content js-simplebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li class="sidebar-item active">
          <a class="sidebar-link" href="/listehisto">
            <i class="align-middle" data-feather="dollar-sign"></i>
            <span class="align-middle"> Gestion de fonds </span>
          </a>
        </li>
        <li class="sidebar-item active">
          <a class="sidebar-link" href="/analysecommission">
            <i class="align-middle" data-feather="dollar-sign"></i>
            <span class="align-middle"> Analyse des commissions </span>
          </a>
        </li>
        <li class="sidebar-item active">
          <a class="sidebar-link" href="/paramcom">
            <i class="align-middle" data-feather="dollar-sign"></i>
            <span class="align-middle"> Parametrage des commissions </span>
          </a>
        </li>
      </ul>
